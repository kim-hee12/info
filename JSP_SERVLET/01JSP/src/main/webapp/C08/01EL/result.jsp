...
<!-- 
	...
	page : 현재 JSP 페이지 내에서만 사용가능한 속성/기능 (관련 내장객체 : pageContext)
	request : 하나의 요청 처리동안 (관련 내장객체 : request)
	session : 일정기간 동안(지정된 혹은 기본값) (관련 내장객체 ; session)
	application : 서버종료시 동안 (관련 내장객체 : application)
-->
