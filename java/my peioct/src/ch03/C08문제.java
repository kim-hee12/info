...
//
//
//		2. 강제 타입 변환에 대한 내용입니다. 컴파일 에러가 발생하는 것은 무엇입니까 [4]
//
//		[예시]
//		----------------------------
//		int intValue = 10;
...
//
//
//		3. 연산식에서의 타입 변환에 대한 내용입니다. 컴파일 에러가 발생하는 것은 무엇입니까? [1]
//		[예시]
//		----------------------------
//		byte byteValue = 10;
...
//		short result = s1 + s2; <- int로 받아들이고 있기 때문에 앞에 (short)를 붙여줘야함
//		int result = i1 + i2;  <- 위에 변수명과 같음
...
//		char c2 = c1 + 1; <- 문자와 숫자의 합이기에 형변환 해줘야함
//		char c2 = (char)(c1 + 1);
...
//		 double, (double)x / y 또는 x / (double)y 또는 (double)x / (double)y		
...
//
//
//		10. 다음코드를 실행했을 때 출력 결과를 적어보세요 [5,23,23]
//		[예시]
//		----------------------------
//		String str1 = 2 + 3 + "";
//		String str2 = 2 + "" + 3;
...
//		 float value =	Float.parseFloa	t("20.5");
