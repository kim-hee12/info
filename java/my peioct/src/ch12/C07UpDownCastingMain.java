...
public class C07UpDownCastingMain {
	...
	public static void main(String[] args) {
		...
		UpDownCastTestFunc(ob1);
//		UpDownCastTestFunc(ob2);
//		UpDownCastTestFunc(ob3);
//		UpDownCastTestFunc(ob4);
//		UpDownCastTestFunc(ob5);
//		UpDownCastTestFunc(ob6);
//		UpDownCastTestFunc(ob7);
	}
