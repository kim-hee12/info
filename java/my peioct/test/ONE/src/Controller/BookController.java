...
public class BookController implements Controller{
	...
	public Map<String, Object> execute(Map<String, Object> params) {
		...
		case 1: // C - 도서 등록
			...
			// 01 파라미터 받기
			int bookcode = (params.get("bookcode") != null) ? (int) params.get("bookcode") : null;
			...
			int CLASSIFICATION_ID = (params.get("CLASSIFICATION_ID") != null) ? (int) params.get("CLASSIFICATION_ID") : null;			
			String BOOK_AUTHOR = (params.get("BOOK_AUTHOR") != null) ? (String) params.get("BOOK_AUTHOR") : null;
			
			BookDTO bookDto = new BookDTO(bookcode,CLASSIFICATION_ID,BOOK_AUTHOR,bookname,publisher,isreserve);
//			if (isValid(bookDto)) {
//				response.put("status", false);
